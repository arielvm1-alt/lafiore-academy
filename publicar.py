# -*- coding: utf-8 -*-
"""
Publicador de carruseles en Instagram (Content Publishing API de Meta).
...
def _peticion(url, datos=None, metodo=None):
    ...
    req.add_header("User-Agent", "lafiore-academy-publisher/1.0")
    try:
...
def crear_estado():
    estado = {
        ...
        "orden": "un set por dia, 12:00 hora de Chile",
        "sets": [
